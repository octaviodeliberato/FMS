...
Em comparação com o modelo construído em `Soja Fase 2.Rmd`, com R^2^ = 0,696, este último modelo apresenta desempenho ligeiramente superior, com R^2^ = `r round(r2.new, 3)`.